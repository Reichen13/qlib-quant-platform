...
if "%PYTHON_EXE%"=="" for /f "delims=" %%P in ('py -3.12 -c "import sys; print(sys.executable)" 2^>nul') do set "PYTHON_EXE=%%P"
if "%PYTHON_EXE%"=="" set "PYTHON_EXE=python"

echo [Qlib Backend] Starting FastAPI on 127.0.0.1:8001 ...
