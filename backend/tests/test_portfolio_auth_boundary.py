...
class PortfolioAuthBoundaryTests(unittest.TestCase):
    def test_portfolio_router_is_user_feature_and_does_not_require_global_api_key(self):
        source = (backend_dir / "api" / "portfolio.py").read_text(encoding="utf-8")
