...
class RiskAuthBoundaryTests(unittest.TestCase):
    def test_risk_router_is_read_compute_and_does_not_require_global_api_key(self):
        source = (backend_dir / "api" / "risk.py").read_text(encoding="utf-8")
